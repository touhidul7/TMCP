...
export async function logToolCall({
  ...
  try {
    ...
    // The insert is deferred past the response (via `after`) so callers never pay log-write
    // latency; the entry itself is built synchronously above while the data is still live.
